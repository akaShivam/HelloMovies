...
object NetworkCallHelper {
    ...
    fun addTopMoviesFromJson(context: Context, pageNo: Int){
        val listJsonStr: String? = NetworkCallUtils.getListResponseFromUrl(NetworkCallUtils.getUrlForTopRated(pageNo))
